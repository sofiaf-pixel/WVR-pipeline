...
def start_up(wvr_scan, bk_tag, pf):
    ...
    D30, D40, D90, D150, D210, D270, newaz = x_am.plot_Trj_az(wvr_scan, remake_post_fig=1, rewrite_txt=0, out_pk='Trj_pk_BAK_old_20220718.txt', posting_folder=pf)
...
def BK_WVR_ts_corr(bk_atmo_diff, bk_atmo_sum, wvr_atmo, xlabels_mask, xlabels_wvr_mask, save_fn_list, save_txt, label):
    ...
    #for i in range(1):
        ...
        print('ts_bk_sum = ', ts_bk_sum)
        print('ts_bk_diff = ', ts_bk_diff)
        print('ts_wvr = ', ts_wvr)
    ...
    for save_fn in save_fn_list:
        pl.savefig(save_fn+label+'_Pearson_Corr_Coeff_v1.png')
    pl.close()
    ...
    pl.suptitle('Pearson Correlation Coefficient')
    for save_fn in save_fn_list:
        pl.savefig(save_fn+label+'_Pearson_Corr_Coeff_v2.png')
    pl.close()
...
def corr_map_fpu(bk_tag, wvr_scan, pf):
    ...
    tod_ground = ets.bk_struct
    #tod_nogroundsub = ets.bk_struct_nogroundsub

    # tod_list = [tod_nogroundsub, tod_ground]
    # label_list = ['_groundsub_False', '_groundsub_True']
    tod_list = [tod_ground]
    label_list = ['_groundsub_True']

    for t_i in range(len(tod_list)):
        ...
        for rx in [270, 210]:
            ...
            for p3_filt in [True, False]:
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_psum-wvr_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_psum-wvr_FPU_'+str(rx)+'_nscanavg_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_pdiff-wvr_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_pdiff-wvr_FPU_'+str(rx)+'_nscanavg_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_psum-pdiff_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_psum-pdiff_FPU_'+str(rx)+'_nscanavg_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_pdiff-wvr_abs_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_pdiff-wvr_abs_FPU_'+str(rx)+'_nscanavg_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_psum-pdiff_abs_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_psum-pdiff_abs_FPU_'+str(rx)+'_nscanavg_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_psum-wvr_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_psum-wvr_FPU_'+str(rx)+'_nscanstd_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_pdiff-wvr_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_pdiff-wvr_FPU_'+str(rx)+'_nscanstd_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_psum-pdiff_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_psum-pdiff_FPU_'+str(rx)+'_nscanstd_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_pdiff-wvr_abs_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_pdiff-wvr_abs_FPU_'+str(rx)+'_nscanstd_p3_'+str(p3_filt)+label+'.png')
                pl.close()
                ...
                cbar.ax.set_ylabel('Pearson Correlation Coefficient [r]')
                pl.savefig(pf+bk_tag+'_psum-pdiff_abs_FPU_'+str(rx)+'_time'+str(time_stamp)+'_p3_'+str(p3_filt)+label+'.png')
                pl.savefig(pf+bk_tag[:8]+'_psum-pdiff_abs_FPU_'+str(rx)+'_nscanstd_p3_'+str(p3_filt)+label+'.png')
                pl.close()
...
def first_plots(wvr_scan, bk_tag, pf):
    ...
    tod_ground = ets.bk_struct
    tod_nogroundsub = ets.bk_struct_nogroundsub
    fs_bk = tod_ground.fs #either of the two
    ...
    for t_i in range(len(tod_list)):
        ...
        for rx in rx_list:
            ...
            for det in range(len(det_a_list)):
                ...
                try:
                    ...
                    for p3_filt in [False]:
                        ...
                        pos4=ax4.imshow(wvr_atmo_Tplanck_tcut, aspect='auto', interpolation='nearest', extent=extent_wvr, origin='lower')
                        ...
                        pl.savefig(pf+'BK_'+bk_tag+'_rx_'+str(rx)+'_idet_'+str(det)+'_WVR_'+wvr_scan[:-4]+'_p3_'+str(p3_filt)+label+'.png')
                        pl.savefig(pf+'ScanPairDate_'+bk_tag[:8]+'_rx_'+str(rx)+'_idet_'+str(det)+'_p3_'+str(p3_filt)+label+'.png')
                        pl.close()
                        ...
                        for i in range(len(tod_bk_diff_list)):
                            ...
                            try:
                                ...
                                print('tod_bk_sum_full_list[i] = ', tod_bk_sum_full_list[i])
                                print('tod_bk_diff_full_list[i] = ', tod_bk_diff_full_list[i])
                                print('nscan '+str(i)+'psum-pdiff correlation failed.')
            ...
            pl.suptitle('Psum-Pdiff Correlation Histogram')
            pl.xlabel('r')
            pl.savefig(pf+'BK_'+bk_tag+'_rx_'+str(rx)+'_idet_histo_WVR_'+wvr_scan[:-4]+'_psum-pdiff_correlation_p3_True'+label+'.png')
            pl.savefig(pf+'ScanPairDate_'+bk_tag[:8]+'_rx_'+str(rx)+'_idet_histo_psum-pdiff_correlation_p3_True'+label+'.png')
            pl.close()
            ...
            pl.suptitle('Psum-Pdiff Correlation Histogram')
            pl.xlabel('r')
            pl.savefig(pf+'BK_'+bk_tag+'_rx_'+str(rx)+'_idet_histo_WVR_'+wvr_scan[:-4]+'_psum-pdiff_correlation_p3_False'+label+'.png')
            pl.savefig(pf+'ScanPairDate_'+bk_tag[:8]+'_rx_'+str(rx)+'_idet_histo_psum-pdiff_correlation_p3_False'+label+'.png')
            pl.close()
